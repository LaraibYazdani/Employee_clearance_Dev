...
function getRoleRedirect(roles: string[]): string {
  ...
  if (roles.includes('FINANCE_MANAGER')) return '/dashboard/hrbp'
  if (roles.some((r) => r.startsWith('DEPT_APPROVER_')) || roles.includes('LINE_MANAGER')) return '/dashboard/approver'
  return '/clearance'
}
